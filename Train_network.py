...
if sourc == 'eagle':
    ...
    extn = '.jpg'
    outfile = './custom-network-eagle/'+division[0]
    edge_cut = 0
elif sourc == 'sdss':
...
for div in division:
    ...
    np.random.seed(0) #Use a known seed to reproduce on other systems
...
for i in range(0, epochs):
    ...
    if save and i > 9 and sum(corr)/num >= acc_old and loss <= loss_old:
